...
const config = {
    serverInfo: {
        ...
        serverName: "AlteCraft Network", /*Server name*/
        serverIp: "play.altecraft.net", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
        discordServerID: "1069761917268263023" /*Your server ID (if you want to add online user counter, you must have enabled Discord server widget)*/
    },
    ...
    */
    ...
    adminTeamPage: {
        OWNER: [
            {
                inGameName: "juegosgame",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
            {
                inGameName: "SCHUTZSTAFFL",
                rank: "Owner",
                skinUrlOrPathToFile: "",
                rankColor: "rgba(255, 3, 3, 1)"
            },
        ...
        HELPER: [
            {
                inGameName: "javixd123",
                rank: "Helper",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
            {
                inGameName: "JHONNY GAMER",
                rank: "Helper",
                skinUrlOrPathToFile: "",
                rankColor: ""
            },
...
const getDiscordOnlineUsers = async () => {
    try {
        ...
        if(!data.presence_count) return "Ninguno";
